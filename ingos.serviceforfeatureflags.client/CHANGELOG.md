...
- Create Angular project with ng: `ng new ingos.serviceforfeatureflags.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ingos.serviceforfeatureflags.client.esproj`).
